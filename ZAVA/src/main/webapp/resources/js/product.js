...
function originHtml(postcode,address,extraAddress,detailAddress){
   var msg = `
			   <div class="inputArea">
				  ...
				  <input name="postcode" type="text" id="" readonly value="${postcode}">
               </div>

               <div class="inputArea">
                  <label for="">주소</label> 
				  <input name="address" type="text" style="width: 365px;" id="" readonly value="${address}"><br>
               </div>

               <div class="inputArea">
                  <label for="">참고 항목</label> 
				  <input name="extraAddress" type="text" style="width: 365px;" id="" placeholder="참고항목" readonly value="${extraAddress}"><br>
               </div>

               <div class="inputArea">
                  <label for="">상세 주소</label> 
				  <input name="detailAddress" type="text" style="width: 365px;" id="" value="${detailAddress}">
               </div>
