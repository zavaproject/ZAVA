   ...
   <div class="orderOpen">
      ...
      <div class="order">
         <form action="/cart/List" method="post">
            ...
            <div class="inputArea">
               <label for="">제품 번호</label> <input type="text" name="pid" id="pid" value="${pid}">
            </div>
            <div class="inputArea">
               <label for="">고객 ID</label> <input type="text" name="mid" id="mid" value="${login.mid}">
            </div>
            <div class="inputArea">
            ...
            <input name="postcode" type="text" id="postcode" readonly value="${login.postcode}" required>
            <input type="button" onclick="execPostcode()" value="우편번호 찾기"><br>
            </div>
         
            <div class="inputArea">
            <label for="">주소</label> 
            <input name="address" type="text" style="width: 365px;" id="address" readonly value="${login.address}" required><br>            
            </div>
            
            <div class="inputArea">
            <label for="">참고 항목</label> 
            <input name="extraAddress" type="text" style="width: 365px;" id="extraAddress" placeholder="참고항목" readonly value="${login.extraAddress}" required><br>
            </div>      
                  
            <div class="inputArea">
            <label for="">상세 주소</label>             
            <input name="detailAddress" type="text" style="width: 365px;" id="detailAddress" value="${login.detailAddress}" required>
            </div>
            ...
            <div class="inputArea">
            <label for="">우편 번호</label> 
            <input name="postcode" type="text" id="postcode" value="" required>
            <input type="button" onclick="execPostcode()" value="우편번호 찾기"><br>
            </div>
         
            <div class="inputArea">
            <label for="">주소</label> 
            <input name="address" type="text" style="width: 365px;" id="address" value="" required><br>            
            </div>
            
            <div class="inputArea">
            <label for="">참고 항목</label> 
            <input name="extraAddress" type="text" style="width: 365px;" id="extraAddress" placeholder="참고항목" value="" required><br>
            </div>      
                  
            <div class="inputArea">
            <label for="">상세 주소</label>             
            <input name="detailAddress" type="text" style="width: 365px;" id="detailAddress" value="" required>
            </div>
            ...
            <br>
            <input id="payment" type="submit" value="주문 결제" class="btn btn-success" />
            <input id="payCancel" type="submit" value="취소" class="btn btn-danger" />
      </form>
      </div>
