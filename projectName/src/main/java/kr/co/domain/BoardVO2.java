...
public class BoardVO2 implements Serializable{
	...
	public BoardVO2(String title, String content, String writer) {
		super();
		this.title = title;
	...
	public BoardVO2(int bno, String title, String content, String writer, 
	...
	public BoardVO2(int bno, String title, String content, String writer, String regdate, String updatedate, int viewcnt,
